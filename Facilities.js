import { initStickyHeader, initHamburger, initScrollAnimations, initAuth, openAuthModal, logoutUser, initRipple, initTiltCards, initPageTransitions } from './shared.js'
...
function initFacParticles() {
  ...
  function Particle() {
    this.reset = function() { this.x = Math.random()*W; this.y = Math.random()*H; this.r = Math.random()*2+0.5; this.vx = (Math.random()-0.5)*0.4; this.vy = (Math.random()-0.5)*0.4-0.2; this.a = Math.random()*0.6+0.2; }
    this.reset()
  }
